    ...
    public partial class initialmigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectTaskStatusLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProjectTaskStatusLogs_ProjectTasks_ProjectTaskId",
                        column: x => x.ProjectTaskId,
                        principalTable: "ProjectTasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProjectTaskStatusLogs_ProjectTaskStatuses_StatusId",
                        column: x => x.StatusId,
                        principalTable: "ProjectTaskStatuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectTaskStatusLogs_ProjectTaskId",
